...
const openWeatherMapURL = 'https://api.openweathermap.org/data/2.5/weather?units=metric';
...
class WeatherModel {
  Future<Map<String, dynamic>> getLocationWeather() async {
    ...
    NetworkHelper networkHelper = NetworkHelper(url: '$openWeatherMapURL&lat=${location.latitude}&lon=${location.longitude}');
